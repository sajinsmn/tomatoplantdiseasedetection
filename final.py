...
def predict():
    ...
    # Return the result page with the prediction, image, and pesticide recommendation
    return render_template('result.html', predicted_class=predicted_class, img_b64=img_b64, recommendation=recommendation)
